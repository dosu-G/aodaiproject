        ...
        <div id="page-container">
            ...
            <div id="inner-container">
                ...
                <div id="page-content">
                    ...
                    <!-- Row Classes -->
                    <h3 class="page-header">QUẢN LÍ LOẠI HÀNG</h3>
                    <table class="table table-borderless">
                        <thead>
                            <tr>
                                ...
                                <th>TÊN LOẠI</th>
                                <th class="cell-small text-center"><i class="fa fa-bolt"></i>Action</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr class="success">
                                ...
                                <td class="text-center">
                                   <a href="index.php?act=edit&id=<?=$row['idmaloai']?>">Sửa</a>
                                   <a href="index.php?act=delete&id=<?=$row['idmaloai']?>">Xóa</a>
                                </td>
                            </tr>
                          <?php }?>
                        </tbody>
