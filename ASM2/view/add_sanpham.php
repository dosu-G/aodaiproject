        ...
        <div id="page-container">
            ...
            <div id="inner-container">
                ...
                <div id="page-content">
                    ...
                    <form action="index.php?act=insert-sanpham" method="POST" enctype="multipart/form-data">

                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">ID SẢN PHẨM</label>
                            <input type="text" name="idsanpham" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="magiamgia" class="form-control" id="exampleInputPassword1">
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">SỐ LƯỢNG</label>
                            <input type="number" name="solg" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                        </div>
                        <div class="mb-3">
                            <div class="form-floating">
                            <label for="floatingTextarea2">Mô tả</label>
                            <textarea class="form-control" name="mota" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 100px"></textarea>
                            </div>
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">HÌNH ẢNH</label>
                            <input type="file" name="filename" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                        </div>
                        <div class="mb-3">
                         
                         <select class="form-select form-select-sm" aria-label=".form-select-sm example" name="maloai">
                             <?php foreach($ds as $row) {?>
                                <option value="<?=$row['idmaloai']?>"><?php if(isset($row['tenloai'])==true){
                                    echo $row['tenloai'];
                                } ?></option>
                            <?php }?>
                         </select> <br>
