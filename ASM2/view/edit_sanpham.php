        ...
        <div id="page-container">
            ...
            <div id="inner-container">
                ...
                <div id="page-content">
                    ...
                    <form action="index.php?act=update_sanpham&id=<?=$row['idsanpham']?>" method="POST">
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">ID SẢN PHẨM</label>
                            <input type="text" placeholder="<?=$row['idsanpham']?>" name="idsanpham" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputPassword1" class="form-label">TÊN SẢN PHẨM</label>
                            <input type="text" placeholder="<?=$row['tensanpham']?>" name="tensp" class="form-control" id="exampleInputPassword1">
                        </div>
                        
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">GIÁ</label>
                            <input type="number" placeholder="<?=$row['giasanpham']?>" name="price" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputPassword1" class="form-label">MÃ GIẢM GIÁ</label>
                            <input type="number" placeholder="<?=$row['magiamgia']?>%" name="magiamgia" class="form-control" id="exampleInputPassword1">
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">SỐ LƯỢNG</label>
                            <input type="number" placeholder="<?=$row['soluong']?>" name="solg" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                        </div>
                        <div class="mb-3">
                         
                         <select class="form-select form-select-sm" aria-label=".form-select-sm example" name="maloai">
                             <?php foreach($ds as $fill) {?>
                                <option value="<?=$fill['idmaloai']?>"><?php if(isset($fill['tenloai'])==true){
                                    echo $fill['tenloai'];
                                } ?></option>
                            <?php }?>
                         </select> <br>
                        ...
                        <button type="submit" class="btn btn-primary" name="send">SỬA</button>
                        </form>
