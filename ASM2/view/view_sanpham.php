        ...
        <div id="page-container">
            ...
            <div id="inner-container">
                ...
                <div id="page-content">
                    ...
                    <!-- With Borders -->
                    <h3 class="page-header">QUẢN LÍ SẢN PHẨM</h3>
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th class="hidden-xs hidden-sm">ID MÃ LOẠI</th>
                                <th class="hidden-xs hidden-sm">MÔ TẢ SẢN PHẨM</th>
                                <th class="cell-small text-center"><i class="fa fa-bolt"></i>HÌNH</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href=""><?=number_format($row['giasanpham'])?> <em>VNĐ</em></a></td>
                                <td class="hidden-xs hidden-sm"><?=$row['soluong']?></td>
                                <td class="hidden-xs hidden-sm"><?=$row['idmaloai']?></td>
                                <td class="hidden-xs hidden-sm"><?=$row['mota']?></td>
                                <td class="hidden-xs hidden-sm">
                                    <img src="../controller/img/file/<?php if(isset($row['hinhanh1'])) {
                                        echo $row['hinhanh1'];
                                    }
                                    else {
                                        echo "erro.jpg";
                                    }
                                    ?>" alt="" width="50px" height="100px" style="object-fit:cover;">
                                </td>
                                <td class="text-center">
                                    <div class="btn-group">
                                        <a href="index.php?act=detail&id=<?=$row['idsanpham']?>" data-toggle="tooltip" title="Details" class="btn btn-xs btn-info"><i class="fa fa-info-circle"></i></a>
                                        <a href="index.php?act=sanpham_edit&id=<?=$row['idsanpham']?>" data-toggle="tooltip" title="Edit" class="btn btn-xs btn-success"><i class="fa fa-pencil"></i></a>
                                        <a href="index.php?act=sanpham_delete&id=<?=$row['idsanpham']?>" data-toggle="tooltip" title="Delete" class="btn btn-xs btn-danger"><i class="fa fa-times"></i></a>
                                    </div>
                                </td>
                            </tr>
                            <?php } ?>
