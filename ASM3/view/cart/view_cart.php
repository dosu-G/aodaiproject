...
<body class="animsition">
	...
	<!-- Title page -->
	<section class="how-overlay2 bg-img1" style="background-image: url(https://theme.hstatic.net/1000136076/1000542013/14/slideshow_2.jpg?v=435);">
		<div class="container">
						...
						<tr class="table_row">
							<td class="column-1">
								<div class="flex-w flex-m">
									<div class="wrap-pic-w size-w-50 bo-all-1 bocl12 m-r-30">
										<img src="../controller/images/file/<?=$value['img']?>" alt="IMG" width="100px" height="100px">
									</div>
							...
							<td class="column-3">
								<div class="wrap-num-product flex-w flex-m bg12 p-rl-10">
									...
									<input class="txt-m-102 cl6 txt-center num-product" type="number" name="num-product1" value="<?=$value['quantity']?>">
							...
							<td class="column-4">
								<div class="flex-w flex-sb-m">
									<span>
										<?=number_format($value['quantity']*$value['price'])?>
									</span>
                                    <a href="index.php?act=deleteCart&id=<?=$value['id']?>">Xóa</a>
								</div>
							</td>
						</tr>
						<?php }?>
