		...
		<div class="container">
			<div class="txt-center p-t-160 p-b-165">
				<h2 class="txt-l-101 cl0 txt-center p-b-14 respon1">
					<?php 
					   if(isset($_SESSION['name'])==true){echo "Chào bạn". ' ' .$_SESSION['name'];} 
					   else{
						   echo "MY ACCOUNT!";
					   }
					?>
			...
			<div class="row">
				<div class="col-md-6 p-b-50">
					<div class="p-r-15 p-rl-0-lg">
						...
						<form class="how-bor3 p-rl-30 p-tb-32" action='login.php?act=checklogin' method='post'>
							<div class="p-b-24">
								<div class="txt-s-101 cl6 p-b-10">
									Username or email address <span class="cl12">*</span>
								</div>
                             
								<input class="txt-s-120 cl3 size-a-21 bo-all-1 bocl15 p-rl-15 " type="text" name="usernameLogin">
								<br>
								<span style="color:red">
								   <?php if(isset($erroLogin['user'])){echo $erroLogin['user'];} ?>
								   <?php if(isset( $erroLogin['emptyuser'])){echo  $erroLogin['emptyuser'];} ?>
								</span>
							</div>
							...
							<div class="p-b-24">
								...
								<input class="txt-s-120 cl3 size-a-21 bo-all-1 bocl15 p-rl-15 " type="password" name="passLogin" >
								<br>
								<span style="color:red">
								   <?php if(isset($erroLogin['pass'])){echo $erroLogin['pass'];} ?>
								   <?php if(isset( $erroLogin['emptyuser'])){echo  $erroLogin['emptyuser'];} ?>
							    </span>
							</div>
							...
							<div class="flex-w flex-m p-t-15 p-b-10">
                                ...
                                <input class="txt-s-120 cl3 size-a-21 bo-all-1 bocl15 p-rl-15" type="submit" name='sendLogin'>
							</div>
				...
				<div class="col-md-6 p-b-50">
					<div class="p-l-15 p-rl-0-lg">
                        ...
                        <form class="how-bor3 p-rl-30 p-tb-32" action='login.php?act=dk' method='post'>
							<div class="p-b-24">
								<div class="txt-s-101 cl6 p-b-10">
									Username <span class="cl12"></span>
                                </div>
								<input class="txt-s-120 cl3 size-a-21 bo-all-1 bocl15 p-rl-15 " id="name" type="text" name="username" > <br>
                                <span id="nameMes" style="color:red">
                                         <?php if(isset($erro['username'])){echo $erro['username'];}?>
										 <?php if(isset($erro['validateUser'])){echo $erro['validateUser'];}?>
                                </span>
							</div>
                            <div class="p-b-24">
								<div class="txt-s-101 cl6 p-b-10">
								...
								<input class="txt-s-120 cl3 size-a-21 bo-all-1 bocl15 p-rl-15 " id="email" type="text" name="email" >
                                <br>
                                <span id="emailMes" style="color:red">
								   <?php if(isset($erro['email'])){echo $erro['email'];}?>
								   <?php if(isset($erro['validateEmail'])){echo $erro['validateEmail'];}?>
								</span>
							</div>
                            <div class="p-b-24">
								<div class="txt-s-101 cl6 p-b-10">
								...
								<input class="txt-s-120 cl3 size-a-21 bo-all-1 bocl15 p-rl-15 " id="number" type="numer" name="phone" >
                                <br>
                                <span id="numMes" style="color:red">
								  <?php if(isset($erro['phone'])){echo $erro['email'];}?>
                                  <?php if(isset($erro['validatePhone'])){echo $erro['validatePhone'];}?>
								</span>
							...
							<div class="p-b-24">
								...
								<input class="txt-s-120 cl3 size-a-21 bo-all-1 bocl15 p-rl-15 " id="pass" type="password" name="pass" >
                                <br>
                                <span id="numMes" style="color:red"><?php if(isset($erro['pass'])){echo $erro['email'];}?></span>
							</div>
							...
							<div class="flex-w flex-m p-t-15 p-b-10">
                                ...
                                <input class="txt-s-120 cl3 size-a-21 bo-all-1 bocl15 p-rl-15" type="submit" name='send' id="send">
							</div>
