			...
			<div class="row">
				<div class="col-md-6 p-b-50">
					<div class="p-r-15 p-rl-0-lg">
						...
						<form class="how-bor3 p-rl-30 p-tb-32" action='index.php?act=checklogin' method='post'>
							<div class="p-b-24">
								<div class="txt-s-101 cl6 p-b-10">
									Username or email address <span class="cl12">*</span>
								</div>
                             
								<input class="txt-s-120 cl3 size-a-21 bo-all-1 bocl15 p-rl-15 " type="text" name="username">
							...
							<div class="p-b-24">
								...
								<input class="txt-s-120 cl3 size-a-21 bo-all-1 bocl15 p-rl-15 " type="password" name="pass" >
								<span style="color:red"></span>
							</div>
							...
							<div class="flex-w flex-m p-t-15 p-b-10">
                                ...
                                <input class="txt-s-120 cl3 size-a-21 bo-all-1 bocl15 p-rl-15" type="submit" name='send'>
							</div>
				...
				<div class="col-md-6 p-b-50">
					<div class="p-l-15 p-rl-0-lg">
                        ...
                        <form class="how-bor3 p-rl-30 p-tb-32" action='index.php?act=dk' method='post'>
							<div class="p-b-24">
								<div class="txt-s-101 cl6 p-b-10">
									Username <span class="cl12">*</span>
                                </div>
								<input class="txt-s-120 cl3 size-a-21 bo-all-1 bocl15 p-rl-15 " id="name" type="text" name="username" >
