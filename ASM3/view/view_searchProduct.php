...
<!-- 
	...
	<!-- Title page -->
	<section class="how-overlay2 bg-img1" style="background-image: url(https://theme.hstatic.net/1000136076/1000542013/14/slideshow_3.jpg?v=409);">
		<div class="container">
					...
					<div class="col-sm-7 col-md-8 col-lg-9">
						<div class="p-t-5 p-b-20">
							...
							<span class="txt-m-117 cl9">
								<p><?=number_format($row['giasanpham'])?> <span>vnđ</span></p>
							</span>
