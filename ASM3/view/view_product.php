				...
				<div class="col-sm-10 col-md-4 col-lg-3 m-rl-auto p-b-50">
					<div class="leftbar p-t-15">
						...
						<div class="size-a-21 pos-relative">
							<form action="index.php?act=searchsanpham" method="POST" class="size-a-21 ">
								<input class="s-full bo-all-1 bocl15 p-rl-20" type="text" name="search" placeholder="Search products...">
								<button class="flex-c-m fs-18 size-a-22 ab-t-r hov11" name="send-search">
					...
					<div>
						<div class="flex-w flex-r-m p-b-45 flex-row-rev">
							<div class="flex-w flex-m p-tb-8">
								...
								<button type="button" class="btn btn-outline-primary"><a href="index.php?act=sanphamAsc">GIÁ GIẢM DẦN</a></button>
								<button type="button" class="btn btn-outline-primary"><a href="index.php?act=sanphamDesc">GIÁ TĂNG DẦN</a></button>
								</div>
								</div>
							</div>
						...
						<div class="shop-grid">
							<div class="row">
							   <?php $ds_pro = $product->getallproduct()?>
							   <?php foreach($ds_pro as $row){?>
										...
										<div class="block1-bg wrap-pic-w bo-all-1 bocl12 hov3 trans-04">
											...
											<div class="block1-content flex-col-c-m p-b-46">
												...
												<div class="block1-wrap-icon flex-c-m flex-w trans-05">
													...
													<a href="index.php?act=cart&id=<?=$row['idsanpham']?>" class="block1-icon flex-c-m wrap-pic-max-w">
														<img src="images/icons/icon-view.png" alt="ICON">
													</a>
